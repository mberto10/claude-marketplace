...
description: Use this skill when the user invokes /optimize, asks to "improve my agent", "run optimization loop", "iterate on agent quality", "systematic agent improvement", or needs guidance on hypothesis-driven optimization cycles. Provides the full methodology for iterative AI agent improvement in Codex.
---
